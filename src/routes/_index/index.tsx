			...
			<Helmet>
				...
				<script type="application/ld+json">
					{`{
						...
						description:
							"Коллекционные статуи, фигурки и саундтреки на виниле из любимых игр и вселенных. SimpleGeek — ваш проводник в мир совершенства форм милых сердцу персонажей по ещё более милым сердцу ценам.",
						potentialAction: {
							"@type": "SearchAction",
